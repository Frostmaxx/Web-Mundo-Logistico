...
$headers .= "From: noreply@mundologistico.com\r\n";
$headers .= "Reply-To: noreply@mundologistico.com\r\n";
...
<body>
    <div class='container'>
        ...
        <div class='footer'>
            <p>Este mensaje fue enviado desde el formulario de contacto de mundologistico.com</p>
    ...
    <div class='container'>
        ...
        <div class='content'>
            <div class='success'>
                ...
                <p>Hemos recibido tu mensaje exitosamente. Nuestro equipo se pondrá en contacto contigo a la brevedad posible.</p>
                <p><strong>Resumen de tu mensaje:</strong></p>
                <p><em>{$mensaje}</em></p>
            </div>
            <br>
            <p>Atentamente,</p>
            <p><strong>Equipo de Mundo Logístico</strong></p>
            <p>📞 +58 424-1549902</p>
            <p>🌐 www.mundologistico.com</p>
        </div>
        <div class='footer'>
...
$headers_reply .= "From: $nombre_empresa <noreply@mundologistico.com>\r\n";

mail($email, "Confirmación de mensaje - Mundo Logístico", $respuesta_cliente, $headers_reply);
...
if ($enviado) {
    ...
    echo json_encode([
        'success' => false, 
        'message' => 'Hubo un error al enviar el mensaje. Por favor intenta más tarde o contáctanos por teléfono.'
    ]);
}
?>
